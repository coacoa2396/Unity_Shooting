...
namespace DesignPattern
{
    public class ObjectPool : MonoBehaviour
    {
        ...
        */
        ...
        {
            PooledObject prefab;
            Stack<PooledObject> objectPool;         // 큐, 리스트로도 가능하긴 한데 스택이 제일 연산이 빠르다
            int poolSize = 100;

            public void CreatePool()            // Pool 채우기
            {
            ...
            public PooledObject GetPool()       // 인스턴스 대여하기
            {
            ...
            public void ReturnPool(PooledObject instance)   // 인스턴스 반납하기
            {
                instance.gameObject.SetActive(false);
                objectPool.Push(instance);
            }
